import type { Invoice, Patient, TicketSettings, User, VenteLine, LabRequest, Company, Consultation, PatientJourneyEvent, EchoRequest, HbRecord, PharmaDeliveryClosing } from '../types';
