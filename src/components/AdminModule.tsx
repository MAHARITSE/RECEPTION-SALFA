                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    <label className="text-sm font-medium flex items-center gap-2">
                      ...
                      Lancer l'impression automatiquement (sans aperçu dans l'app)
                    </label>
                    <p className="text-[11px] text-slate-500 leading-snug pl-6">
                      Les tickets partent directement vers l'imprimante par défaut.
                      Pour supprimer aussi la boîte de dialogue Windows/Chrome : lancer l'application via le script
                      <code className="mx-1 px-1 bg-slate-200 rounded">lancer-impression-directe.bat</code>
                      (qui ouvre Chrome/Edge avec <code className="mx-1 px-1 bg-slate-200 rounded">--kiosk-printing</code>)
                      et définir votre imprimante thermique comme imprimante par défaut Windows.
                    </p>
                    <label className="text-sm font-medium flex items-center gap-2">
