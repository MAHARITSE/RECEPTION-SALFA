        ...
        <div className="bg-white rounded-xl shadow-sm border overflow-hidden mt-0 order-first">
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-4 gap-2">
                <div><label className="block text-[10px] font-bold text-slate-600 mb-1">Prix Comptoir</label><input type="number" value={examForm.priceComptoir} onChange={(e) => setExamForm({ ...examForm, priceComptoir: parseFloat(e.target.value) || 0 })} className="w-full px-2 py-1.5 border rounded outline-none" /></div>
                <div><label className="block text-[10px] font-bold text-slate-600 mb-1">Prix Société</label><input type="number" value={examForm.priceSociete} onChange={(e) => setExamForm({ ...examForm, priceSociete: parseFloat(e.target.value) || 0 })} className="w-full px-2 py-1.5 border rounded outline-none" /></div>
                <div><label className="block text-[10px] font-bold text-slate-600 mb-1">Prix Externe</label><input type="number" value={examForm.priceExterne} onChange={(e) => setExamForm({ ...examForm, priceExterne: parseFloat(e.target.value) || 0 })} className="w-full px-2 py-1.5 border rounded outline-none" /></div>
                <div><label className="block text-[10px] font-bold text-slate-600 mb-1">Prix Urgent</label><input type="number" value={examForm.urgentPrice} onChange={(e) => setExamForm({ ...examForm, urgentPrice: parseFloat(e.target.value) || 0 })} className="w-full px-2 py-1.5 border rounded outline-none" /></div>
              </div>
              <div className="grid grid-cols-2 gap-3">
