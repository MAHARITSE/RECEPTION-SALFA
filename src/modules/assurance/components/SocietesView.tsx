...
import { Building, Plus, Search, Edit3, Trash2, Phone, Mail, MapPin, X, Layers, GitMerge, CheckSquare, Square, ArrowRight, Check, Sparkles, RefreshCw, ShieldOff } from 'lucide-react';
...
export const SocietesView: React.FC<SocietesViewProps> = ({
  ...
  const [filtreMode, setFiltreMode] = useState<'all' | 'global' | 'partiel'>('all');
  ...
  const filtered = societes.filter(s => {
    if (filtreMode !== 'all' && societeModePaiement(s) !== filtreMode) return false;
